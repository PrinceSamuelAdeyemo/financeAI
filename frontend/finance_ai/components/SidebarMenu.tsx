...
export default function SidebarMenu({openSidebar, sidebarVisible}: {openSidebar:boolean, sidebarVisible: ModalHandlerType}){
    return (
        <div className={`absolute h-[100vh] -top-14 left-0 w-full bg-purple-200 z-20 transition-transform duration-300 ease-in-out transform ${openSidebar ? 'translate-x-0': '-translate-x-full'} lg:hidden`}>
